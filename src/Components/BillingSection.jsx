  ...
  return (
    <div className="container mx-auto p-6 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg">
        ...
        <div className="text-xl font-bold text-yellow-600 flex justify-between">
          <span>Total</span>
        ...
        {/* Place Order Button */}
        <button className="w-full bg-gray-900 text-white py-2 rounded-lg hover:bg-gray-700 transition mt-4">
          Place order
        </button>
      </div>
    </div>
